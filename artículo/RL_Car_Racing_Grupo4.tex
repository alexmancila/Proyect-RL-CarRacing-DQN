...
\begin{figure}[!t]
\centering
\includegraphics[width=0.8\linewidth]{figuras/carracing_entorno.png}
\caption{Vista del entorno de simulación CarRacing-v3: observación RGB de $96\times 96$ píxeles desde perspectiva cenital, mostrando el vehículo (centro) navegando por la pista generada proceduralmente.}
\label{fig:carracing_entorno}
\end{figure}
