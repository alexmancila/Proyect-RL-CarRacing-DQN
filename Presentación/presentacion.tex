...
\begin{frame}{Visualización del Entorno}
    \begin{center}
        \includegraphics[width=0.58\textwidth]{figuras/carracing_entorno.png}
    \end{center}
...
\begin{frame}{Diagrama de Arquitectura del Proyecto}
    \centering
    \includegraphics[width=0.94\textwidth,height=0.75\textheight,keepaspectratio]{figuras/diagrama.png}
...
\begin{frame}{Gráfico: Recompensa durante Entrenamiento (Comparativa)}
    \begin{columns}[T]
        ...
        \centering
        \textbf{DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dqn_grafico_reward.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_double_dqn_grafico_reward.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Dueling Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dueling_double_dqn_grafico_reward.png}
    \end{columns}
...
\begin{frame}{Gráfico: Loss durante Entrenamiento (Comparativa)}
    \begin{columns}[T]
        ...
        \centering
        \textbf{DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dqn_grafico_loss.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_double_dqn_grafico_loss.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Dueling Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dueling_double_dqn_grafico_loss.png}
    \end{columns}
...
\begin{frame}{Gráfico: Decaimiento de Epsilon (Comparativa)}
    \begin{columns}[T]
        ...
        \centering
        \textbf{DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dqn_grafico_epsilon.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_double_dqn_grafico_epsilon.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Dueling Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dueling_double_dqn_grafico_epsilon.png}
    \end{columns}
...
\begin{frame}{Gráfico: Crecimiento del Replay Buffer (Comparativa)}
    \begin{columns}[T]
        ...
        \centering
        \textbf{DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dqn_grafico_buffer.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_double_dqn_grafico_buffer.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Dueling Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/exp1000_dueling_double_dqn_grafico_buffer.png}
    \end{columns}
...
\begin{frame}{Gráfico: Entrenamiento a 1000 Episodios (Comparativa)}
    \begin{columns}[T]
        ...
        \centering
        \textbf{DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/eval1000_dqn_grafico_rewards.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/eval1000_double_dqn_grafico_rewards.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Dueling Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/eval1000_dueling_double_dqn_grafico_rewards.png}
    \end{columns}
...
\begin{frame}{Gráfico: Entrenamiento a 200 Episodios (Comparativa)}
    \begin{columns}[T]
        ...
        \centering
        \textbf{DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/eval200_dqn_grafico_rewards.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/eval200_double_dqn_grafico_rewards.png}
        
        \column{0.33\textwidth}
        \centering
        \textbf{Dueling Double DQN}\\
        \includegraphics[width=0.95\textwidth,height=0.45\textheight,keepaspectratio]{figuras/eval200_dueling_double_dqn_grafico_rewards.png}
    \end{columns}
