...
\begin{frame}{Evaluación a 200 Episodios}
    \begin{table}[!h]
        \centering
        \footnotesize
...
\begin{frame}{Evaluación a 1000 Episodios}
    \begin{table}[!h]
        \centering
        \footnotesize
        \begin{tabular}{lrrrrrr}
...
\begin{frame}{Gráfico: Evaluación a 1000 Episodios (Comparativa)}
    \begin{columns}[T]
        \column{0.33\textwidth}
        \centering
        \textbf{DQN}\\
...
\begin{frame}{Gráfico: Evaluación a 200 Episodios (Comparativa)}
    \begin{columns}[T]
        \column{0.33\textwidth}
        \centering
        \textbf{DQN}\\
